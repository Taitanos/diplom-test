const lodgingObjects = [
    {
        ...
        rate: 4.1,
        description: "Большая и просторная спальня-студия с собственной ванной комнатой. Удобные кровати размера «king-size» и зона отдыха. Расположен в парке Аравана Ридженси в центре Бангкока. Прямо внизу есть семейный магазин.",
    ...
    },
    {
        ...
        rate: 4.7,
        description: "Рядом с железнодорожной станцией BTS Thong Lo sky 300 метров. Центр удобной жизни. Уютная однокомнатная квартира будет полностью оборудована. В этом номере есть 1 большая двуспальная кровать (качественная кровать), 1 обеденный стол, 1 небольшая кухня и 1 ванная комната. Бесплатный вай-фай. Вы можете наслаждаться приготовлением легких блюд с кухонными принадлежностями на кухне. Рядом есть магазин и магазины уличной еды.",
    ...
    },
    {
        ...
        rate: 4.8,
        description: "Теплый и гостеприимный отель с 1 спальней, оформленный в классическом стиле, расположенный в окружении молодых денег района Тонглор/Эккамай. 200 метров до станции Skytrain BTS Ekkamai. 2 балкона, один в гостиной и один в спальне, дизайн интерьера в японском минималистском стиле. Хорошо оборудованные помещения с бассейном и тренажерным залом. Превосходное расположение всех леденящих кровь ресторанов, баров, клубов и уличной еды.",
    ...
    },
    {
        ...
        location: {country: "Thailand", city: "Bangkok", address: "4/12 Soi Sukhumvit"},
        rate: 4.5,
        description: "В этом номере есть 1 спальня с 1 кроватью размера «king-size». Этот номер расположен в районе Асоке, в 3 минутах ходьбы от BTS Asoke и Nana, а также от Терминала 21 и в нескольких минутах от линии связи с аэропортом, а также недалеко от Сиама, Сиамского Парагона, ресторанов, баров, клубов, массажных салонов, Сиама. торговый центр, ночная жизнь, великолепные виды. Вам понравится мое место из-за видов, расположения, атмосферы и бангкокского сердца. Мое место подходит для каждой группы, такой как семейная пара.",
    ...
    },
    {
        ...
        rate: 4.6,
        description: "Наслаждайтесь легким доступом к такси, всего в 3 минутах ходьбы находится станция Pak Nam Skytrain, откуда можно добраться до самых популярных направлений, включая пирс Чао Прайя, железнодорожную линию аэропорта и метро MRT. Это даст вам доступ к Paragon & Emporium, аэропорту Суварнабхуми и даже к рынку Чатучак. Также в 2 минутах ходьбы находится популярный тайский ресторан Sanctuary и кафе Illy с садовым декором и романтической атмосферой.",
    ...
    },
    {
        ...
        rate: 4.9,
        description: "Моя квартира расположена в самом сердце Лагуны, в роскошном кондоминиуме на пляже, всего в 250 метрах от легендарного пляжа Лагуна Бангтао. Завтрак \"шведский стол\" включен в стоимость. Пейзажный бассейн с видом на море. Вам понравится мое место из-за расположения, видов и уюта. Бассейн и бар с видом на море на закате. Особенный и действительно уникальный. Легко ходить везде. Очень тихий, спокойный и безопасный район. Спортзал. Стоянка. Бесплатные услуги по уборке предоставляются один раз в два дня.",
    ...
    },
    {
        ...
        rate: 4.9,
        description: "Наша квартира расположена в Cassia Residence в районе Laguna BangTao Beach с круглосуточной охраной. Бесплатная парковка, высокоскоростной интернет, доступное телевидение Netflix и Youtube, объединили все виды кухонного оборудования. Две спальни с двумя ванными комнатами, а также с двумя балконами. Сделайте ваше пребывание более комфортным с семьей и друзьями! В нескольких минутах ходьбы от пляжа и Боут-авеню. Большой выбор ресторанов / мест для позднего завтрака / Барки / пляжных баров / пляжных ресторанов / баров. Бесплатный автобус в районе Лагуны!",
    ...
    },
    {
        ...
        rate: 4.8,
        description: "Наша квартира на первом этаже расположена в 150 м от пляжа Бангтао, одного из самых длинных и красивых пляжей Пхукета. Bangtao Beach Gardens — жилой комплекс современных просторных апартаментов. Он может похвастаться превосходными бассейнами, тренажерным залом и красивым садом на фоне тропических гор. Наш кондоминиум на первом этаже имеет две спальни с ванными комнатами, европейскую кухню и большую столовую / гостиную, а также террасу в саду.",
    ...
    },
    {
        ...
        location: {country: "Thailand", city: "Phuket", address: "Soi Had Surin 8"},
        rate: 4.7,
        description: "Недавно построенный курорт, расположенный на пляже Сурин, примерно в 45 минутах езды от международного аэропорта Пхукета.",
    ...
    },
    {
        ...
        location: {country: "Thailand", city: "Phuket", address: "Soi Had Surin 8"},
        rate: 4.3,
        description: "Уютная, хорошо меблированная, полностью оборудованная, эта прекрасная студия в самом сердце Сурина расположена в красивом комплексе всего в 800 м от кристально чистой воды с белым песчаным пляжем Сурина. Кондоминиум находится под управлением отеля и предоставляет полный спектр услуг: стойка регистрации/лобби, ресторан на крыше, лаунж-бар, полностью оборудованный тренажерный зал, бассейн на крыше с видом на море, бар у бассейна. Автобус-шаттл позволяет добраться до пляжа всего за 2 минуты, что делает его еще более удобным. Рестораны, спа и магазины рядом с комплексом находятся всего в нескольких метрах ходьбы",
    ...
    },
    {
        ...
        rate: 4.3,
        description: "Эти апартаменты расположены прямо напротив знаменитой гавани Лачи. Это полностью кондиционированное помещение с полностью оборудованной кухней и прекрасным видом на бассейн комплекса. В нем есть смарт-телевизор и совместное беспроводное подключение к Интернету со скоростью 300 Мбит/с с несколькими другими квартирами. Через дорогу расположено множество рыбных таверн и ресторанов, служба такси, два центра водных видов спорта, два супермаркета, аптека и ювелирный магазин. Пляж, организованный муниципалитетом, также находится в нескольких минутах ходьбы.",
    ...
    },
    {
        ...
        location: {country: "Cyprus", city: "Polis", address: "Poli Crysochous"},
        rate: 4.6,
        description: "Расположенная на пляже популярного курорта Лачи, эта квартира с 1 спальней на первом этаже находится в прекрасном месте. Рестораны, магазины и бары Лачи находятся в нескольких минутах ходьбы, что делает его идеальным для тех, кто хочет расслабиться и отдохнуть. В квартире есть гостиная/кухня открытой планировки с патио-дверями, ведущими на крытую террасу с великолепным видом на море, которая идеально подходит для завтрака и вечернего коктейля.",
    ...
    },
    {
        ...
        rate: 4.7,
        description: "Дом верхнего этажа расположен в комплексе домов в центре поселков Полис Хрисохус, Продроми и Лаци. Благодаря своему расположению доступ к различным деревням стал более эффективным. Пляж находится примерно в 600 метрах, и вы даже можете пойти пешком, если у вас нет машины. Автобусная остановка находится снаружи на главной улице (опять же в нескольких минутах ходьбы), а напротив главной дороги есть небольшой супермаркет, где вы можете купить все, что вам может понадобиться для вашего отпуска.",
    ...
    },
    {
        ...
        location: {country: "Cyprus", city: "Polis", address: "Akamantos Avenue"},
        rate: 4.8,
        description: "Это красивый дом с двумя спальнями и собственной террасой на крыше. Он современно оформлен с кондиционером во всех комнатах. Нетфликс предоставляется бесплатно. Вы можете использовать частную террасу на крыше, чтобы позагорать на солнце или выпить бокал вина под потолочным окном, любуясь прекрасным видом на море и горы. В доме есть общий бассейн и выделенное подземное парковочное место. Он расположен недалеко от удобств и в нескольких минутах езды от пляжа.",
    ...
    },
    {
        ...
        location: {country: "Cyprus", city: "Polis", address: "Akamantos Avenue"},
        rate: 4.6,
        description: "Crocus Veneris — это красивый дом в районе Продроми, идеально подходящий для спокойного отдыха на природе, на одних из самых красивых пляжей Кипра и в гавани Лачи. С тремя доступными спальнями, главной спальней на первом этаже, спальней с односпальной кроватью и спальней с двумя односпальными кроватями на втором этаже могут разместиться до пяти человек. В этом доме есть студия йоги и большой сад, идеальное место для отдыха за чашечкой послеобеденного кофе в сопровождении фруктов с деревьев.",
